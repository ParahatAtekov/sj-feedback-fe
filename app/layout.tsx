          ...
          <nav className="bg-zinc-900 p-4">
            <div className="max-w-6xl mx-auto flex flex-col sm:flex-row justify-between items-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-center">
                <Link href="/" className="text-gray-300 hover:text-white font-light transition">
                  Home
                </Link>
                <Link href="/feedback/view" className="text-gray-300 hover:text-white font-light transition">
                  View Feedback
                </Link>
                <FeedbackButton />
              </div>
