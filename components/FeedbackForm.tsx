...
export default function FeedbackForm() {
    ...
    const haldeFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl mx-auto bg-white p-6 rounded-lg shadow"  >
            <div>
                ...
                <select 
                    ...
                    <option value="very_dissatisfied">Very disappointed</option>
                    <option value="somewhat_dissatisfied">Somewhat disappointed</option>
                    <option value="not_dissatisfied">Not disappointed</option> 
            ...
            <button type="submit" disabled={isPending} className="w-full py-2 px-4 bg-blue-600 text-white rounded-md hover:bg-blue-700 disabled:opacity-50">
